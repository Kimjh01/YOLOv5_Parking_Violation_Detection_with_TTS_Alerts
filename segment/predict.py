...
Usage - formats:
    $ python segment/predict.py --weights yolov5s-seg.pt
                                          yolov5s-seg.torchscript
                                          yolov5s-seg.onnx
                                          yolov5s-seg_openvino_model
                                          yolov5s-seg.engine
                                          yolov5s-seg.mlmodel
                                          yolov5s-seg_saved_model
                                          yolov5s-seg.pb
                                          yolov5s-seg.tflite
                                          yolov5s-seg_edgetpu.tflite
                                          yolov5s-seg_paddle_model
"""
